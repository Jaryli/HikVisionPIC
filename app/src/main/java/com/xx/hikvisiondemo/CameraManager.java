...
//    }
    ...
    public void loginDevice() {
        ...
        LogUtil.e("下面是设备信息************************");
        LogUtil.e("userId=" + m_iLogID);
        LogUtil.e("通道开始=" + deviceInfo_V30.byStartChan);
        LogUtil.e("通道个数=" + deviceInfo_V30.byChanNum);
        LogUtil.e("设备类型=" + deviceInfo_V30.byDVRType);
        LogUtil.e("ip通道个数=" + deviceInfo_V30.byIPChanNum);
